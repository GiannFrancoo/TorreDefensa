...
public class ExplosionBomba extends HiloAnimacion {
	...
	public ExplosionBomba(MapaLogico mapaLogico, int x, int y) {
		...
		this.label.setIcon(new ImageIcon(new ImageIcon(getClass().getClassLoader().getResource("texturas/objetos/bomba/bomba_explosion.gif")).getImage().getScaledInstance(label.getWidth(), label.getHeight(), Image.SCALE_DEFAULT)));
		this.tiempo = 1000;
	}
